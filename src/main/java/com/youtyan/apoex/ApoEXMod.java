...
import com.youtyan.apoex.affix.ApoExGeneratorCategories;
...
public class ApoEXMod {
    public ApoEXMod() {
        ...
        AddonModuleRegistry.INSTANCE.LoadModule(new ApoExModuleProvider(FMLJavaModLoadingContext.get()), builder);
